...
cp -v "content/mm-${COMMIT_TAG}-3domode.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-3domode.uqm"
cp -v "content/mm-${COMMIT_TAG}-3dovoice.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-3dovoice.uqm"
cp -v "content/mm-${COMMIT_TAG}-dosmode.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-dosmode.uqm"
cp -v "content/mm-${COMMIT_TAG}-hd-classic-pack.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-hd-classic-pack.uqm"
cp -v "content/mm-${COMMIT_TAG}-hd-content.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-hd-content.uqm"
cp -v "content/mm-${COMMIT_TAG}-volasaurus-remix-pack.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-${COMMIT_TAG}-volasaurus-remix-pack.uqm"
cp -v "content/uqm-${COMPAT_VER}-3DOMusicRemastered.uqm" "${diststart}/2645580/dist/megamod/content/addons/uqm-${COMPAT_VER}-3DOMusicRemastered.uqm"
cp -v "content/uqm-${COMPAT_VER}-3dovideo.uqm" "${diststart}/2645580/dist/megamod/content/addons/uqm-${COMPAT_VER}-3dovideo.uqm"
cp -v "content/mm-vols-space.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-vols-space.uqm"
cp -v "content/mm-rmx-utwig.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-rmx-utwig.uqm"
cp -v "content/mm-remix-timing.uqm" "${diststart}/2645580/dist/megamod/content/addons/mm-remix-timing.uqm"
